    ...
    namespace Core
    {
        public static class DataUtility
        {
            ...
            public static void SetMask(this Dictionary<string, DataNode> data, string key, ulong value) => data.SetLong(key, unchecked((long)value));
            ...
            public static ulong GetMask(this Dictionary<string, DataNode> data, string key, ulong def = 0) => unchecked((ulong)data.GetLong(key, unchecked((long)def)));
