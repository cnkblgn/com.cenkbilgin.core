...
namespace Core.UI
{
    ...
    public sealed class ManagerUI : Manager<ManagerUI>
    {
        ...
        {
            waypointController.Insert(data, offset, inputContext.Camera);
        ...
        public void RemoveWaypoint(in Guid id) => waypointController.Remove(id);
        ...
        public void ShowViewport(string id, ViewportMesh mesh) => viewportController.Show(id, mesh);
