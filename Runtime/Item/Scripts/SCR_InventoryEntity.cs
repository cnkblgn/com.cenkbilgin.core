...
namespace Core.Item
{
    ...
    public sealed class InventoryEntity : MonoBehaviour, IInventoryUser
    {
        ...
        public bool IsSwapValid(Guid instanceID, Guid targetInstanceID, InventoryEntity targetInventory, out InventoryResult result) => IsSwapValid(instanceID, targetInstanceID, targetInventory.thisInventory, out result);
