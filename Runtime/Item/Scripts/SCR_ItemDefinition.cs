...
namespace Core.Item
{
    public sealed class ItemDefinition
    {
        ...
        public ItemDefinition(ItemID id, ItemTag[] tags, PrefabID entityID, PrefabID equipableID, IconID iconID,  LocalizedID nameID, LocalizedID descID, int width, int height, int stack, float weight, ItemComponent component)
        {
            ID = id;
