...
namespace Core.Editor
{
    ...
    public abstract class EditorDrawSearchable : PropertyDrawer
    {
        ...
        protected virtual UnityEngine.Object GetAsset(string key) => null;
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            EditorGUI.BeginProperty(position, label, property);
            {
                ...
                if (GUI.Button(GetPingRect(position, lineHeight), PING_BUTTON_ICON, EditorStyles.miniButton))
                {
                    UnityEngine.Object asset = GetAsset(key.stringValue);
        ...
        private void DrawList(Rect rect, SerializedProperty property, SerializedProperty keyProperty, State state)
        {
            ...
            state.Scroll = GUI.BeginScrollView(rect, state.Scroll, viewRect);
            {
                ...
                DrawRow(ref y, viewRect.width, SEARCH_NONE_TEXT, property, keyProperty, state, STRING_EMPTY);
        ...
        private Rect GetFieldRect(Rect position, float lineHeight)
        {
            ...
            (
                position.x,
                position.y,
                position.width - PING_BUTTON_SIZE - 2,
                lineHeight
            );
        }
