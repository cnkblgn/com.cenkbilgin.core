...
namespace Core
{
    ...
    public sealed class DebugCommandInstance : DebugCommandInstanceBase
    {
    ...
    public sealed class DebugCommandInstance<T1> : DebugCommandInstanceBase
    {
    ...
    public sealed class DebugCommandInstance<T1, T2> : DebugCommandInstanceBase
    {
