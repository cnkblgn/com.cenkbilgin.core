...
{
    internal static class LightAnimator
    {
        ...
        private static string Get(LightAnimation id) => data[(int)id];
        internal static float Calculate(LightAnimation id, float rate)
        {
            if (id == LightAnimation.DEFAULT)
            {
                return 1;
            }
