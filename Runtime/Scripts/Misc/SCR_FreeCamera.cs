...
namespace Core.Misc
{
    ...
    public class FreeCamera : MonoBehaviour
    {
        ...
        private void Update()
        {
            inputScroll = ManagerCoreInput.Instance.AxisScroll.Value.x;
            inputLook = ManagerCoreInput.Instance.AxisLook.Value;
            inputMove = ManagerCoreInput.Instance.AxisMove.Value;
