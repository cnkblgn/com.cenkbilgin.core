...
namespace Core.UI
{
    ...
    public class UIPointerEventScale : UIPointerEvent
    {
        ...
        private TweenScaleRect thisTween = null;
        ...
        private void Scale(float scalePower, float scaleDelay, float scaleDuration, EaseType easeType)
        {
            ...
            thisTween = thisTransform.Scale(endValue, scaleDuration, scaleDelay, UpdateType.UNSCALED, easeType, () => thisTween = thisTransform.Scale(defaultScale, scaleDuration, 0, UpdateType.UNSCALED, easeType));
        }
    }
}