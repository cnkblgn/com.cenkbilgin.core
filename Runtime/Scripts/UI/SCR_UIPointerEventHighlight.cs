...
namespace Core.UI
{
    ...
    public sealed class UIPointerEventHighlight : UIPointerEvent
    {
        ...
        private void RevertColor()
        {
            ...
            thisTween?.Stop();
            thisTween = thisImage.Fade(defaultColor, defaultColor.a, fadeDuration, 0, TweenType.UNSCALED, fadeEasingType);
            ...
            if (influenceChild)
            {
                ...
                {
                    childTweens[i]?.Stop();
                    childTweens[i] = childImages[i].Fade(defaultColor, defaultColor.a, fadeDuration, 0, TweenType.UNSCALED, fadeEasingType);
                }
            }
        }
        ...
        private void HighlightColor()
        {
            ...
            thisTween?.Stop();
            thisTween = thisImage.Fade(highlightColor, highlightColor.a, fadeDuration, 0, TweenType.UNSCALED, fadeEasingType);
            ...
            if (influenceChild)
            {
                ...
                {
                    childTweens[i]?.Stop();
                    childTweens[i] = childImages[i].Fade(highlightColor, highlightColor.a, fadeDuration, 0, TweenType.UNSCALED, fadeEasingType);
                }
            }
        }
