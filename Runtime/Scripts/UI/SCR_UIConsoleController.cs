...
namespace Core.UI
{
    ...
    public class UIConsoleController : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (ManagerCoreInput.Instance.KeyConsole.IsPressedDown)
            {
                if (!isOpen)
                {
                    Show();
            ...
            if (isOpen)
            {
                ManagerCoreInput.Instance.Disable();
                ...
                {
                    if (ManagerCoreInput.Instance.KeyNavigateDown.IsPressedDown)
                    {
                        MoveSuggestion(1);
                    }
                    else if (ManagerCoreInput.Instance.KeyNavigateUp.IsPressedDown)
                    {
                        MoveSuggestion(-1);
                    }
                    else if (ManagerCoreInput.Instance.KeyTab.IsPressedDown)
                    {
                        ApplySuggestion();
                    }
                }
                ...
                {
                    if (ManagerCoreInput.Instance.KeyNavigateUp.IsPressedDown)
                    {
        ...
        public void Hide()
        {
            ...
            {
                ManagerCoreInput.Instance.Enable();
            }
